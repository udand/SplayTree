/**
 * SplayTree class performs
 * insert,remove,find and tostring preorder,leafCount,leafSum functions.
 * @author Umang
 */
...
public class SplayTree {
	...
	public static void main(String[] args) {
		...
		System.out.println("Leave counts :" + impl.leafCount(impl.getRoot()));
		System.out.println("Leave counts :" + impl.leafSum(impl.getRoot()));
		
		System.out.println("Remove:"+impl.remove(22));
		System.out.println("After delete preorder:"+impl);
		
		System.out.println("Node found or not :"+impl.find(42));
		System.out.println("After search preorder:"+impl);

		System.out.println("Node found or not :"+impl.find(98)); // node note in tree
		System.out.println("After search preorder:"+impl);
